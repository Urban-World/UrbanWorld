...
from kaolin.io.utils import heterogeneous_mesh_handler_naive_homogenize
...
class Mesh:
    def __init__(self, mesh_path, device, target_scale=1.0, mesh_dy=0.0,
        ...
        if ".obj" in mesh_path:
            try:
                ...
                mesh = kal.io.obj.import_mesh(mesh_path, with_normals=True, with_materials=False,heterogeneous_mesh_handler=heterogeneous_mesh_handler_naive_homogenize)
    ...
    def preprocess_gltf(self, mesh_path, remove_mesh_part_names, remove_unsupported_buffers):
        with open(mesh_path, "r") as fr:
            ...
            if remove_mesh_part_names is None:
                temp_primitives = []
